...
public class ItemServiceImpl implements ItemService {
	...
	@Override
	public void calculateDueQuantity(ItemBudgetToSave item, int quantity) throws ItemQuantityNotAllowed {
	...
	@Override
	public void applyGlobalDiscount(@NotNull Collection<? extends ItemBudgetToSave> items, BigDecimal discount) {
		items.parallelStream().forEach(i -> {
			ItemBudgetToSaveValues price = i.getValues();
	...
	@Override
	public void applyLineDiscount(@NotNull Collection<? extends ItemBudgetToSave> items, ItemLineDiscountForm itemLineDiscount) {
	...
	private void calculateTotals(ItemBudgetToSave item) {
	...
	private void calculateTotals(ItemBudgetToSave item, int quantity) {
		ItemBudgetToSaveValues prices = item.getValues();
	...
	private BigDecimal[] applyDiscount(ItemBudgetToSave item, BigDecimal discount) {
		ItemBudgetToSaveValues price = item.getValues();
	...
	@Override
	public boolean checkQuantityPolicies(ItemBudgetToSave item, int quantity) {
